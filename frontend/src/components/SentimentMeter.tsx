...
export const SentimentMeter = ({ sentiment, urgency }: { sentiment: string, urgency: number }) => (
  <div className="flex items-center space-x-4 md:space-x-8 w-full md:w-auto md:min-w-[300px]">
    <div className="flex-1 flex items-center">
      <Activity className="w-4 h-4 text-gray-400 mr-2 md:mr-3 shrink-0" />
    ...
    <div className="flex-1 flex items-center">
      <span className="text-[10px] md:text-xs font-bold text-gray-500 mr-2 md:mr-3 uppercase shrink-0">Urgency</span>
