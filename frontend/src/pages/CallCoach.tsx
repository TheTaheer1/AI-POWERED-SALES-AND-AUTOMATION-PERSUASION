      ...
      <div className="shrink-0 w-full p-4 md:p-6 border-b border-gray-800 bg-black/50 backdrop-blur-md flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 z-20">
        <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
          <button
            ...
            className={`shrink-0 flex items-center justify-center min-w-[140px] h-[44px] px-4 rounded-lg font-bold uppercase tracking-wider text-sm transition-all whitespace-nowrap ${
              isRecording 
          ...
          <div className="flex items-center gap-4">
            {isRecording && (
              <div className="flex items-center text-red-500 font-mono font-bold animate-pulse text-sm">
                <div className="w-2.5 h-2.5 rounded-full bg-red-500 mr-2"></div>
                LIVE
              </div>
            )}

            <div className="flex items-center text-gray-400 font-mono text-lg">
